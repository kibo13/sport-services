...
class CreateMethodRequest extends FormRequest
{
    ...
    {
        return [
            'activity_id' => 'required|unique:methods,activity_id,' . $this->id . ',id,number,' . $this->number,
            'number' => 'required|unique:methods,number,' . $this->id . ',id,activity_id,' . $this->activity_id,
            'note' => 'nullable',
        ];
    }
